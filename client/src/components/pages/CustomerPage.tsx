...
const CustomerPage = (props: any) => {
    ...
    const initialFormDataState = { _id: uuidv4(), name: '', description: '' };
    ...
    const handleDoubleClickRow = (dataIndex: any) => {
        ...
        setFormData({ _id: data._id, name: data.name, description: data.description });
        setIsOpenFormDialog(true);
    ...
    tableData.forEach((td: any) => {
        data.push({ "_id": td._id, "name": td.name, "description": td.description })
    })
                ...
                <>
                    ...
                    <Dialog fullWidth={true} open={isOpenFormDialog} onClose={handleCloseFormDialog} aria-labelledby="form-dialog-title">
                        <form
                            ...
                            noValidate
                        >
                            <DialogTitle id="form-dialog-title">{dialogType === DIALOG_TYPE.REGISTER ? "Register New Customer" : "Edit Customer"}</DialogTitle>
                            <DialogContent>
                                <TextField
                                    value={formData.name}
                                    margin="normal"
