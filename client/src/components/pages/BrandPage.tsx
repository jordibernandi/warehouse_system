...
const BrandPage = (props: any) => {
    ...
    const submit = async (e: any) => {
        ...
        if (dialogType === DIALOG_TYPE.REGISTER) {
            await BrandService.add(formData).then((res: any) => {
            ...
            await BrandService.edit(formData._id, formData).then((res: any) => {
    ...
    const submitDelete = async (e: any) => {
        ...
        await BrandService.softDelete({ selectedData: selectedData }).then((res: any) => {
            const tempTableData = [...tableData]
                ...
                <>
                    ...
                    <Dialog fullWidth={true} open={isOpenFormDialog} onClose={handleCloseFormDialog} aria-labelledby="form-dialog-title">
                        <form
                            ...
                            noValidate
                        >
                            <DialogTitle id="form-dialog-title">{dialogType === DIALOG_TYPE.REGISTER ? "Register New Brand" : "Edit Brand"}</DialogTitle>
                            <DialogContent>
                                <TextField
                                    value={formData.name}
                                    margin="normal"
